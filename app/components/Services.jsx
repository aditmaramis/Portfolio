	...
	return (
		...
		>
			...
			<motion.p
				...
				className="text-center max-w-2xl mx-auto mt-5 mb-12 px-10"
			>
				i offer end-to-end digital solutions including web development and UI/UX
				design. i also provide custom graphic design services to help brands
				stand out with visually compelling and user-friendly experiences. my
				journey from hotel floors to full-stack frameworks taught me that every
				detail matters — in service, and in software.
			</motion.p>
